/**
 * @source https://github.com/flarum/framework/blob/main/framework/core/js/src/common/Component.ts
 */
...
> implements ClassComponent<A> {
  ...
  /**
   * Saves the vnode attrs as a collection after running them through initAttrs,
